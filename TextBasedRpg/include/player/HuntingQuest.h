...
public:
    HuntingQuest(const std::string& name, const std::string& description, int experienceReward, int goldReward, std::vector<std::string> itemReward, std::string monsterToKill, int monsterToKillCount) :
        Quest(name, description, experienceReward, goldReward, std::move(itemReward)),
